        ...
        : seed.venueId === "venue-jichi-first-hokkaido-kaderu27"
          ...
          : seed.venueId === "venue-jichi-first-aomori-toonippo-news"
            ? {
                ...
                accessNote:
                  "青森県から出願する受験者の2027年1月25日（月）の学力試験と、学力試験に及第した受験者の翌1月26日（火）の面接に使われる会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち青森県が指定する時間です。施設案内はJR青森駅から徒歩10分、会場を東奥日報新町ビル3階のNew’sホールと案内しています。3階にはホールA〜Eがありますが、試験で使うホール・室、受付位置、受験生入口は未公表です。施設の通常利用時間9:00〜18:00を試験日の開場時刻とみなさず、受験票、青森県から交付される案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-iwate-espoir"
            ? {
                ...
                accessNote:
                  "岩手県から出願する受験者の2027年1月25日（月）の学力試験と、学力試験に及第した受験者の翌1月26日（火）の面接に使われる会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち岩手県が指定する時間です。施設公式はJR盛岡駅から徒歩20分、路線バスの中央通一丁目停留所から徒歩5分と案内しています。館内には複数の会議室・ホールと宿泊客室がありますが、試験で使う階・室、受付位置、受験生入口は未公表です。一般宿泊の正面玄関が24:00〜6:00に施錠される案内や施設の通常利用時間を試験日の開場・受験生入口とみなさず、受験票、岩手県から交付される案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-fukushima-nakamachi"
            ? {
                ...
                accessNote:
                  "福島県から出願する受験者の2027年1月25日（月）の学力試験と、学力試験に及第した受験者の翌1月26日（火）の面接に使われる会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち福島県が指定する時間です。施設公式は所在地を福島市中町7番17号とし、4階から6階に収容人数の異なる6会議室を案内していますが、試験で使う階・室、受付位置、受験生入口は未公表です。会議室の通常利用開始9:00や鍵の受渡し8:30を入試の開場・受付時刻とみなさず、受験票、福島県から交付される案内、当日掲示を確認してください。会議室利用者用の駐車場はないため、徒歩で向かえる宿泊拠点を優先しています。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-gunma-meeting-293"
            ? {
                ...
                officialUrlLabel: "群馬県庁 公式フロア案内・利用時間",
                accessNote:
                  "群馬県から出願し、前日の学力試験に及第した受験者の2027年1月26日（火）の面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち群馬県が指定する時間です。群馬県庁公式フロア案内は293会議室が本庁舎29階にあることを示しています。県庁公式はJR前橋駅からバス約6分、新前橋駅・中央前橋駅からバス約7分と案内していますが、2027年1月26日のダイヤは未公表です。29階293会議室までは公表済みですが、試験当日の受付位置、受験生入口、利用するエレベーター、待機場所は未公表です。前日1月25日（月）の学力試験は同じ29階の291会議室という別会場のため取り違えないでください。通常開庁時刻や一般来庁者向けの入口を面接日の指定動線とみなさず、受験票、群馬県から交付される案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-chiba-plaza-nanohana"
            ? {
                ...
                accessNote:
                  "千葉県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち千葉県が指定する時間です。ホテル公式は千葉都市モノレール県庁前駅から徒歩1分、JR本千葉駅から徒歩3分と案内し、千葉県の公的会場図は京成千葉中央駅から徒歩約15分と案内しています。自治医科大学の2027年度募集要項は施設名と住所までを公表していますが、学力・面接それぞれの使用階・会議室、受付位置、受験生入口、待機場所は未公表です。ホテル公式に掲載される大会議室「菜の花」などを入試会場とみなさず、受験票、千葉県から交付される試験専用案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-niigata-jichikaikan"
            ? {
                ...
                accessNote:
                  "新潟県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち新潟県が指定する時間です。会館を運営する新潟県市町村総合事務組合の公式会場案内は、新潟交通の県庁・県庁前停留所、またはJR越後線関屋駅から徒歩約22分と案内しています。新潟交通の現行C1県庁線は新潟駅と県庁・県庁前を結びますが、2027年1月25日・26日のダイヤは未公表です。自治会館は本館と別館からなり複数の会議室がありますが、2027年入試の使用棟・階・室、受付位置、受験生入口、待機場所は未公表です。2026年度の別の試験資料に掲載された201会議室を2027年度へ流用せず、受験票、新潟県から交付される試験専用案内、当日掲示を確認してください。近隣の新潟自治労会館（新光町6番地7）とは別施設です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-ishikawa-meeting-1103"
            ? {
                ...
                officialUrlLabel: "石川県庁 公式交通案内",
                accessNote:
                  "石川県から出願し、前日の学力試験に及第した受験者の2027年1月26日（火）の面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち石川県が指定する時間です。自治医科大学の2027年度募集要項は石川県庁行政庁舎11階1103会議室までを公表しています。県庁公式はJR金沢駅金沢港口（西口）から北陸鉄道バス約10分、県庁前停留所下車と案内していますが、2027年1月26日の確定ダイヤ・乗り場・積雪時運行は未公表です。受験生入口、受付位置、待機場所、入館手順は未公表のため、県庁前停留所、行政庁舎の一般入口、通常来庁者向け案内を試験指定とみなさず、受験票、石川県から交付される試験専用案内、当日掲示を確認してください。前日1月25日（月）の学力試験は同庁舎11階1105会議室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-nagano-prefectural-office"
            ? {
                ...
                accessNote:
                  "長野県から出願し、前日の学力試験に及第した受験者の2027年1月26日（火）の面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち長野県が指定する時間です。長野県公式はJR長野駅から徒歩約15分、バス約6分と案内していますが、2027年1月26日の確定ダイヤ・系統・乗り場・積雪時運行は未公表です。県庁は本館棟、西庁舎、議会棟などに分かれますが、自治医科大学の2027年度募集要項は試験棟・階・室、受付位置、受験生入口、待機場所を公表していません。通常開庁は8:30〜17:15で面接受付開始前ですが、通常開庁時刻、本館1階の受付案内・県民ホール、一般来庁者向け入口を試験指定とみなさず、受験票、長野県から交付される試験専用案内、当日掲示を確認してください。前日1月25日（月）の学力試験は長野県自治会館という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-aichi-winc-aichi"
            ? {
                ...
                accessNote:
                  "愛知県から出願する受験者の2027年1月25日（月）の学力試験と、学力試験に及第した受験者の翌1月26日（火）の面接は、いずれも自治医科大学の2027年度募集要項で「愛知県産業労働センター（ウインクあいち）」と公表されています。学力試験は受付8:20〜8:40・試験9:00〜14:10、面接は受付9:00〜9:20・10:10〜16:00のうち愛知県が指定する時間です。施設公式はJR名古屋駅桜通口から徒歩5分、ユニモール地下街5番出口から徒歩2分と案内しています。施設は地下3階〜地上18階にホール、展示場、会議室などを持ちますが、募集要項は両日とも使用階・室名、受付位置、受験生入口、待機場所を公表していません。施設公式の受付時間9:00〜20:00、1階エントランスホール、一般来館者向け受付を試験指定とみなさず、受験票、愛知県から交付される試験専用案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-shiga-collab-3f"
            ? {
                ...
                accessNote:
                  "滋賀県から出願し、前日の学力試験に及第した受験者の2027年1月26日（火）の面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち滋賀県が指定する時間で、自治医科大学の2027年度募集要項はコラボしが21の3階中会議室2までを公表しています。施設運営者の公式案内は京阪石山坂本線の石場駅から徒歩3分とし、滋賀県公式はJR琵琶湖線の膳所駅から徒歩15分と案内しています。ただし受験生入口、受付位置、待機場所、入館手順は未公表です。施設内のBiz Baseは1階の一般利用施設で、貸会議室の通常利用時間や一般来館者向け入口・受付を試験指定とみなさず、受験票、滋賀県から交付される試験専用案内、当日掲示を確認してください。前日の学力試験は滋賀県庁東館7階大会議室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-hyogo-kyosai"
            ? {
                ...
                accessNote:
                  "兵庫県から出願し、前日の学力試験に及第した受験者の2027年1月26日（火）の面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち兵庫県が指定する時間で、自治医科大学の2027年度募集要項は会場をひょうご共済会館と公表しています。施設公式は神戸市営地下鉄西神・山手線の県庁前駅から徒歩5分、JR神戸線・阪神本線の元町駅から徒歩10分と案内しています。施設は宿泊客室のほか、定員108名のツツジなど複数の会議室・宴会場を備えますが、募集要項は面接の使用階・室名、受付位置、受験生入口、待機場所、宿泊者向け館内動線を公表していません。公式施設案内にある正面玄関、宿泊フロント、一般会議室、通常利用時間を面接指定とみなさず、受験票、兵庫県から交付される試験専用案内、当日掲示を確認してください。前日の学力試験は兵庫県農業共済会館という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-nara-nobotel"
            ? {
                ...
                accessNote:
                  "奈良県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち奈良県が指定する時間です。施設公式は近鉄奈良線の新大宮駅から徒歩約8分、奈良交通の奈良市庁前停留所から徒歩1〜2分、JR奈良駅から徒歩約19分と案内しています。ホテルは264室の宿泊客室と宴会場Earth・Water、会議室Windを備えますが、自治医科大学の2027年度募集要項は試験の使用階・室名、受付位置、受験生入口、待機場所、宿泊者向け館内動線を公表していません。ホテル正面玄関、宿泊フロント、各宴会・会議室、通常利用時間を試験指定とみなさず、受験票、奈良県から交付される試験専用案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-wakayama-kenmin-bunka"
            ? {
                ...
                accessNote:
                  "和歌山県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち和歌山県が指定する時間です。施設は和歌山県庁正門前にあり、県公式の現行案内では和歌山バス県庁前停留所から徒歩約4分です。地下1階・地上6階に大・小ホール、22会議室、4展示室、和室がありますが、自治医科大学の2027年度募集要項は使用階・室名、受付位置、受験生入口、待機場所を公表していません。施設の通常開館8:45は学力試験の受付8:20より遅いため、一般開館時刻、1階総合受付、正面玄関、各ホール・会議室を試験指定とみなさず、受験票、和歌山県から交付される試験専用案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-shimane-sunport-murakumo"
            ? {
                ...
                accessNote:
                  "島根県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち島根県が指定する時間です。施設公式はJR松江駅2番バス乗場から県民会館前停留所まで約12分、同停留所下車すぐと案内し、館内2階に瑞雲、祥雲、彩雲、八雲、白雲、興雲などの会議・宴会場があることを確認できます。ただし自治医科大学の2027年度募集要項は使用階・室名、受付位置、受験生入口、待機場所、面接順を公表していません。会議室の一般利用案内や早朝料金区分、1階フロント・ラウンジ、正面玄関を試験指定とみなさず、受験票、島根県から交付される試験専用案内、当日掲示を確認してください。施設内には一般向け宿泊客室もありますが、客室から試験室までの館内動線・所要は未公表です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-hiroshima-mielparque"
            ? {
                ...
                accessNote:
                  "広島県から出願する受験者の2027年1月25日（月）の学力試験と、これに及第した受験者の翌1月26日（火）の面接に共通する会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち広島県が指定する時間です。施設公式は紙屋町西停留場と広島バスセンターから徒歩1分と案内し、館内に複数の宴会場・会議室があることを確認できます。ただし自治医科大学の2027年度募集要項は使用階・室名、受付位置、受験生入口、待機場所、面接順を公表していません。施設公式の一般フロアガイド、1階フロント、3階バスセンター連絡通路、宴会・会議の通常受付・営業時間を試験日の指定入口・開場・使用室とみなさず、受験票、広島県から交付される試験専用案内、当日掲示を確認してください。施設内には一般向け宿泊客室もありますが、客室から試験室までの館内動線・所要は未公表です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-yamaguchi-meeting-2-3"
            ? {
                ...
                officialUrlLabel: "山口県 公式庁舎フロア案内",
                accessNote:
                  "山口県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち山口県が指定する時間で、自治医科大学の2027年度募集要項は会場を山口県庁の『共用第2・第3会議室（4階）』と公表しています。県公式フロア案内は共用第1〜第5会議室を本館低層棟4階に掲載し、県庁前停留所から県庁舎玄関まで約300mと案内しています。ただし第2・第3会議室の使い分け、受付位置、受験生入口、待機場所、面接順、低層棟4階までの指定動線は未公表です。低層棟1階の一般受付・正面玄関、4階の正庁会議室や他の共用会議室を面接指定とみなさず、受験票、山口県から交付される面接専用案内、当日掲示を確認してください。前日の学力試験は本館高層棟1階の視聴覚室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-kagawa-main-12f"
            ? {
                ...
                accessNote:
                  "香川県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち香川県が指定する時間で、自治医科大学の2027年度募集要項は会場を香川県庁の『本館会議室（12階）』と公表しています。県公式フロア案内は本館12階に大会議室と第1〜第7会議室があることを示しますが、面接で使う個別会議室、受付位置、受験生入口、待機場所、面接順、エレベーター、指定動線は未公表です。特定の会議室を面接会場と推定せず、受験票、香川県から交付される面接専用案内、当日掲示を確認してください。前日の学力試験は北館3階会議室という別会場で、北館や303〜306会議室を翌日の面接会場とみなさないでください。県公式アクセスはJR高松駅から徒歩約20分、または琴電瓦町駅から徒歩約10分と案内しています。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          ...
          : seed.venueId === "venue-jichi-first-kumamoto-hotel-terza"
            ? {
                postalCode: "862-0956",
                address: "熊本県熊本市中央区水前寺公園28番51号",
                nearestStations: [
                  "熊本市電 市立体育館前停留場",
                  "路線バス・空港リムジンバス 熊本県庁前停留所",
                ],
                officialUrl: "https://kumamoto-terrsa.com/floor",
                officialUrlLabel: "ホテル熊本テルサ 公式フロア・館内案内",
                accessNote:
                  "熊本県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち熊本県が指定する時間で、自治医科大学の2027年度募集要項は会場を『ホテル熊本テルサ』と公表しています。ホテル公式は熊本県庁前停留所から徒歩5分、市立体育館前停留場から徒歩10分と案内しています。施設内にはテルサホール、会議室、宴会場など複数の催事室がありますが、2027年面接の使用室、受付位置、受験生入口、待機場所、面接順、エレベーター、指定動線は未公表です。特定のホール・会議室や一般フロントを面接会場・受付と推定せず、受験票、熊本県から交付される面接専用案内、当日掲示を確認してください。前日の学力試験は熊本県庁本館地下1階の地下大会議室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-oita-new-large-meeting"
            ? {
                postalCode: "870-8501",
                address: "大分県大分市大手町3丁目1番1号",
                nearestStations: [
                  "JR日豊本線・久大本線・豊肥本線 大分駅",
                  "大分バス・大分交通 県庁前停留所",
                ],
                officialUrl: "https://www.pref.oita.jp/site/chosha/chosha-b.html",
                officialUrlLabel: "大分県 公式県庁舎新館フロア案内",
                accessNote:
                  "大分県から出願する受験者の2027年1月25日（月）の学力試験会場です。受付は8:20〜8:40、試験は9:00〜14:10で、自治医科大学の2027年度募集要項は会場を『大分県庁舎 新館大会議室』と公表しています。大分県公式の現行フロア案内は大会議室を新館14階に掲載しています。ただし、2027年入試の受付位置、受験生入口、待機場所、使用するエレベーター・階段、指定動線は未公表です。新館の一般来庁入口、1階受付や通常の館内動線を入試動線と推定せず、受験票、大分県から交付される試験専用案内、当日掲示を確認してください。大分県公式はJR大分駅から県庁まで徒歩約15分と案内しています。翌1月26日（火）の面接は同じ大分県庁舎内の会議室ですが、使用館・階・室名が未公表の別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-oita-meeting-room"
            ? {
                postalCode: "870-8501",
                address: "大分県大分市大手町3丁目1番1号",
                nearestStations: [
                ...
                officialUrl: "https://www.pref.oita.jp/site/chosha/list69-167.html",
                officialUrlLabel: "大分県 公式県庁舎配置図・館内案内",
                accessNote:
                  "大分県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち大分県が指定する時間で、自治医科大学の2027年度募集要項は会場を『大分県庁舎 会議室』とだけ公表しています。大分県公式の現行館内案内には本館・新館などに複数の会議室があるため、使用館・階・室名、受付位置、受験生入口、待機場所、面接順、エレベーター・階段、指定動線は現時点で特定できません。前日の学力試験会場である新館14階大会議室を面接室と推定せず、受験票、大分県から交付される面接専用案内、当日掲示を確認してください。大分県公式はJR大分駅から県庁まで徒歩約15分と案内しています。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-miyazaki-mrt-micc"
            ? {
                postalCode: "880-0001",
                address: "宮崎県宮崎市橘通西4丁目6番3号",
                nearestStations: ["JR日豊本線・日南線 宮崎駅"],
                officialUrl: "https://www.mrt.jp/event/contents/2026radio_fes/",
                officialUrlLabel: "MRT宮崎放送 公式イベント案内（会場営業確認）",
                accessNote:
                  "宮崎県から出願する受験者の2027年1月25日（月）の学力試験会場です。受付は8:20〜8:40、試験は9:00〜14:10で、自治医科大学の2027年度募集要項は会場を『MRT micc・ダイヤモンドホール（2階）』、住所を宮崎市橘通西4丁目6番3号と公表しています。MRT宮崎放送の2026年公式イベント案内でダイヤモンドホールの営業継続を確認し、宮崎県の近年の公式行事案内も同じ住所の2階ダイヤモンドホールとしています。ただし、2027年入試の受付位置、受験生入口、待機場所、使用するエレベーター・階段、指定動線は未公表です。一般催事の入口や館内動線を入試動線と推定せず、受験票、宮崎県から交付される試験専用案内、当日掲示を確認してください。旧会場サイトのURLは現在会場案内ではない別サイトへ転送されるため、過去の階数・フロア情報を2027年入試に流用していません。翌1月26日（火）の面接は宮崎県庁防災庁舎7階の防71号室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-miyazaki-disaster-71"
            ? {
                postalCode: "880-8501",
                address: "宮崎県宮崎市橘通東2丁目10番1号",
                nearestStations: [
                  "JR日豊本線・日南線 宮崎駅",
                  "宮崎交通 橘通2丁目停留所",
                ],
                ...
                officialUrlLabel: "宮崎県 公式防災庁舎フロア案内",
                accessNote:
                  "宮崎県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち宮崎県が指定する時間で、自治医科大学の2027年度募集要項は会場を『宮崎県庁防災庁舎 防71号室（7階）』、住所を宮崎市橘通東2丁目10番1号と公表しています。宮崎県公式の現行フロア案内でも、防災庁舎7階に防71号室から防75号室までの共用会議室があることを確認できます。ただし、2027年面接の受付位置、受験生入口、待機場所、面接順、使用するエレベーター・階段、指定動線は未公表です。1階の屋外エントランス、守衛室、一般来庁動線を面接入口・受付と推定せず、受験票、宮崎県から交付される面接専用案内、当日掲示を確認してください。宮崎県公式はJR宮崎駅から橘通2丁目停留所までバス7分、同停留所から県庁まで徒歩5分と案内していますが、2027年の便時刻・道路所要は未確定です。前日の学力試験はMRT micc・ダイヤモンドホール2階という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-kagoshima-auditorium-2f"
            ? {
                postalCode: "890-8577",
                address: "鹿児島県鹿児島市鴨池新町10番1号",
                nearestStations: [
                  "鹿児島市営バス・鹿児島交通 県庁前停留所",
                  "鹿児島市電 郡元電停",
                ],
                officialUrl: "https://www.pref.kagoshima.jp/aa02/chosha.html",
                officialUrlLabel: "鹿児島県 公式県庁舎フロア・アクセス案内",
                accessNote:
                  "鹿児島県から出願する受験者の2027年1月25日（月）の学力試験会場です。受付は8:20〜8:40、試験は9:00〜14:10で、自治医科大学の2027年度募集要項は会場を『鹿児島県庁 行政庁舎 講堂（2階）』、住所を鹿児島市鴨池新町10番1号と公表しています。鹿児島県公式の現行庁舎案内でも行政庁舎2階に講堂があることを確認できます。ただし、2027年入試の受付位置、受験生入口、待機場所、使用するエレベーター・階段、指定動線は未公表です。行政庁舎の一般来庁入口や1階総合案内を入試入口・受付と推定せず、受験票、鹿児島県から交付される試験専用案内、当日掲示を確認してください。県公式は鹿児島中央駅東15乗り場から県庁前停留所へ向かう複数のバス系統と、郡元電停から徒歩15分（約900m）を案内していますが、2027年の便時刻・道路所要は未確定です。翌1月26日（火）の面接は同じ行政庁舎16階の16-A-1会議室という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-kagoshima-meeting-16a1"
            ? {
                postalCode: "890-8577",
                address: "鹿児島県鹿児島市鴨池新町10番1号",
                nearestStations: [
                ...
                officialUrlLabel: "鹿児島県 公式県庁舎フロア・アクセス案内",
                accessNote:
                  "鹿児島県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:10〜16:00のうち鹿児島県が指定する時間で、自治医科大学の2027年度募集要項は会場を『鹿児島県庁 行政庁舎 16-A-1会議室（16階）』、住所を鹿児島市鴨池新町10番1号と公表しています。募集要項の会場表は画像でも確認し、上段の学力試験会場である2階講堂と、下段の面接試験会場である16階16-A-1会議室を区別しています。鹿児島県公式の現行庁舎案内でも、行政庁舎16階に16-A-1会議室があることを確認できます。ただし、2027年面接の受付位置、受験生入口、待機場所、面接順、使用するエレベーター・階段、指定動線は未公表です。行政庁舎の一般来庁入口や1階総合案内を面接入口・受付と推定せず、受験票、鹿児島県から交付される面接専用案内、当日掲示を確認してください。県公式は鹿児島中央駅東15乗り場から県庁前停留所へ向かう複数のバス系統と、郡元電停から徒歩15分（約900m）を案内していますが、2027年の便時刻・道路所要は未確定です。前日の学力試験は同じ行政庁舎2階の講堂という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : seed.venueId === "venue-jichi-first-okinawa-municipal-autonomy"
            ? {
                postalCode: "900-0029",
                address: "沖縄県那覇市旭町116番地37",
                nearestStations: ["沖縄都市モノレール 旭橋駅"],
                officialUrl: "https://okinawa-jichikaikan.com/?page_id=136",
                officialUrlLabel: "沖縄県市町村自治会館 公式交通アクセス",
                accessNote:
                  "沖縄県から出願する受験者の2027年1月25日（月）の学力試験と、学力試験に及第した受験者が翌1月26日（火）に受ける面接の共通会場です。学力試験は受付8:20〜8:40、試験9:00〜14:10、面接は受付9:00〜9:20、10:10〜16:00のうち沖縄県が指定する時間です。自治医科大学の2027年度募集要項は両日とも会場を『沖縄県市町村自治会館』、住所を那覇市旭町116-37と公表しています。会館公式の現行交通案内は、沖縄都市モノレール旭橋駅の改札から陸橋・連絡通路を経て自治会館側入口へ至る一般来館動線を案内していますが、公式の徒歩分数は掲載していません。また、2027年入試で使用する階・ホール・会議室、受付位置、受験生入口、待機場所、使用するエレベーター・階段、指定動線は未公表です。会館公式の自治会館側入口や一般フロア案内を試験入口・受付と推定せず、受験票、沖縄県から交付される試験・面接専用案内、当日掲示を確認してください。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
          : {}),
    });
...
export const privateMedicalExamVenues2027: PrivateMedicalExamVenue2027[] = [
  ...
  },
  {
    ...
    municipality: "久留米市",
    nearestStations: [
      "西鉄天神大牟田線 西鉄久留米駅から西鉄バス",
      "JR鹿児島本線・九州新幹線 久留米駅から西鉄バス",
      "西鉄バス 大学病院・医学部前停留所",
    ],
    officialUrl: "https://www.kurume-u.ac.jp/access/",
    officialUrlLabel: "久留米大学 公式アクセス・キャンパス案内",
    accessNote: "久留米大学医学部医学科の2027年度後期一般選抜二次試験は3月16日（火）に旭町キャンパスで実施されます。前期・後期一般選抜の学生募集要項は10月中旬公開予定で、現時点では開場・入室・集合・試験開始時刻、使用棟・階・試験室、受付位置、受験生入口は未公表です。大学公式は西鉄久留米駅から西鉄バス8番で大学病院または医学部前まで約15分、JR久留米駅から西鉄バス18番で同停留所まで約7分と案内しています。キャンパスマップには医学部各棟と大学病院が掲載されていますが、特定の棟・病院入口・停留所を試験入口とはみなしません。10月中旬公開予定の学生募集要項、受験票、当日案内を確認してください。",
    reviewState: "verified",
    verifiedAt: "2026-08-19T00:00:00+09:00",
  },
  {
  ...
  },
  {
    ...
    officialUrlLabel: "タイム24ビル 公式交通アクセス",
    accessNote: "福岡大学医学部医学科の2027年度一般選抜・系統別日程一次選考は2月2日（火）に実施され、東京試験場はタイム24ビルです。希望会場の収容人数を超えた場合は別会場になるため、出願確認票・受験票で最終会場を確認してください。一般選抜の入試要項は9月下旬公開予定で、現時点では開場・入室・集合・試験開始時刻、使用階・研修室・会議室、受付位置、受験生入口は未公表です。施設公式はゆりかもめテレコムセンター駅から徒歩約2分と案内していますが、これは一般来館地点までの案内で指定試験室までの時間ではありません。施設の通常利用時間や一般入口を入試の開場時刻・入口に転用せず、入試要項、受験票、当日案内を確認してください。",
    reviewState: "verified",
    verifiedAt: "2026-08-19T00:00:00+09:00",
  },
  {
...
setPlan("jichi-medical--general--general", "second", {
  ...
  reviewState: "verified",
  note: "会場は自治医科大学で固定です。出願都道府県により第1・第2グループに分かれ、面接・学力試験の受付時刻と実施順が異なります。公開要項では試験棟・試験室・受付位置・受験生入口を指定していないため、第1次合格者へ交付される第2次試験の案内、受験票、当日掲示を確認してください。",
});
...
officialVenuePlan(["iwate-medical--general--general"], "first", {
  ...
  reviewState: "monitoring",
  note: "矢巾キャンパスは正式会場として公表済みです。公式FAQは一般選抜を希望会場で受験できると案内していますが、東京・大阪・札幌・名古屋・福岡は都市までの公表です。学外施設名と最終会場は、9月末までに公開予定の学生募集要項および受験票で確認してください。",
});
officialVenuePlan(["iwate-medical--general--general"], "second", {
  ...
  conditions: ["applicant_preference", "university_assigned", "admission_ticket"],
  officialAdmissionUrl: iwateVenueUrl,
  evidenceLabel: "大学公式2027年度入試概要・医学部入試案内・FAQ",
  evidenceLocator: "医学部 一般選抜二次「試験日・試験会場」・医学部「二次試験」・FAQ「希望の会場で受験できるか」",
  reviewState: "monitoring",
...
officialVenuePlan(["jichi-medical--general--general"], "first", {
  ...
  announcedVenueText: "出願都道府県別の学力試験場・面接試験場（正式施設を公表済み。一部会場は試験室まで公表）",
  publicationState: "confirmed",
  conditions: ["fixed", "admission_ticket"],
