        ...
        : seed.venueId === "venue-jichi-first-hokkaido-kaderu27"
          ...
          : seed.venueId === "venue-jichi-first-miyazaki-disaster-71"
            ? {
                ...
                accessNote:
                  "宮崎県から出願し、2027年1月25日（月）の学力試験に及第した受験者が翌1月26日（火）に受ける面接会場です。受付は9:00〜9:20、面接は10:00〜16:00のうち宮崎県が指定する時間で、自治医科大学の2027年度募集要項は会場を『宮崎県庁防災庁舎 防71号室（7階）』、住所を宮崎市橘通東2丁目10番1号と公表しています。宮崎県公式の現行フロア案内でも、防災庁舎7階に防71号室から防75号室までの共用会議室があることを確認できます。ただし、2027年面接の受付位置、受験生入口、待機場所、面接順、使用するエレベーター・階段、指定動線は未公表です。1階の屋外エントランス、守衛室、一般来庁動線を面接入口・受付と推定せず、受験票、宮崎県から交付される面接専用案内、当日掲示を確認してください。宮崎県公式はJR宮崎駅から橘通2丁目停留所までバス7分、同停留所から県庁まで徒歩5分と案内していますが、2027年の便時刻・道路所要は未確定です。前日の学力試験はMRT micc・ダイヤモンドホール2階という別会場です。",
                verifiedAt: "2026-08-19T00:00:00+09:00",
              }
