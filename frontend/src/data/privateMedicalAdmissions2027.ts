  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        procedure: "2/25（必着）",
        sourceUrl: "https://www.kyorin-u.ac.jp/univ/center/nyugaku/web_youkou/PDF/2027youkou.pdf",
      }),
      officialRoute({
        name: "大学入学共通テスト利用選抜",
        category: "common",
  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        sourceUrl: "https://www.twmu-u.jp/wp-content/uploads/2026/08/30cfa9d6198a1f4ca4a002eee2df2651.pdf",
      }),
    ],
  },
  {
  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        sourceUrl: "https://kindai.jp/exam/system/general1_a/",
      }),
      officialRoute({
        name: "地域枠入試 一般前期型（大阪府・和歌山県・静岡県／認可申請予定）",
        category: "general",
        application:
          "Web・書類 2026/12/18〜2027/1/14（Web終了時刻は入学試験要項公開待ち・書類1/14消印有効）",
        ...
        sourceUrl: "https://kindai.jp/assets/pdf/exam/exam-guide-2027.pdf",
      }),
      officialRoute({
        name: "一般選抜 後期",
        category: "general",
        ...
        sourceUrl: "https://kindai.jp/exam/system/general2/",
      }),
      officialRoute({
        name: "地域枠入試 一般後期型（静岡県／認可申請予定）",
        category: "general",
        application:
          "Web・書類 2027/2/1〜2/15（Web終了時刻は入学試験要項公開待ち・書類2/15消印有効）",
      ...
      officialRoute({
        ...
        sourceUrl: "https://kindai.jp/exam/system/center/",
      }),
      officialRoute({
        name: "共通テスト利用 中期",
        category: "common",
  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        category: "general",
        application:
          "出願・検定料納付 2026/12/15〜2027/1/7（Web終了時刻・書類提出方法／期限は10月中旬公開予定の募集要項で確認）",
      ...
      officialRoute({
        ...
        category: "general",
        application:
          "出願・検定料納付 2027/2/6〜2/25（Web終了時刻・書類提出方法／期限は10月中旬公開予定の募集要項で確認）",
        applicationDeadlineDateDetails: [
          "出願・検定料納付締切（Web終了時刻・書類提出方法／期限は募集要項公開待ち）",
        ],
        firstExam: "3/8",
...
export const applicationDeadlineEntries2027: ApplicationDeadlineEntry2027[] = [
  ...
  },
  {
    ...
    university: "久留米大学",
    routes: "一般前期",
    webDeadline: "1/7（終了時刻は募集要項公開待ち）",
    documentDeadline: "提出方法・期限は10月中旬公開予定の募集要項で確認",
    sourceUrl: "https://best.kurume-u.ac.jp/admissions/type/exam-first/",
  },
  {
    date: "1/7",
  ...
  },
  {
    ...
    dateTime: "2027-01-14",
    university: "近畿大学",
    routes: "一般前期／地域枠・前期型（認可申請予定）",
    webDeadline: "1/14（時刻は要項公開待ち）",
  ...
  },
  {
    ...
    university: "愛知医科大学",
    routes: "一般選抜",
    webDeadline: "1/22 17:00",
    documentDeadline: "1/22 消印有効",
    sourceUrl: "https://www.aichi-med-u.ac.jp/files/igaku/2027nenndogakuseibosyuuyoukou_0731.pdf",
  },
  {
    date: "1/22",
  ...
  },
  {
    ...
    dateTime: "2027-02-15",
    university: "近畿大学",
    routes: "一般後期／地域枠・後期型（認可申請予定）",
    webDeadline: "2/15（時刻は要項公開待ち）",
