...
const examCalendarEvents2027 = [
  ...
  },
  {
    ...
    second: ["自治医科（一般）", "国際医療福祉③（一般／2/1〜6の指定日）"],
  },
  {
    date: "2/4",
    weekday: "木",
  ...
  },
  {
    ...
    second: [
      "岩手医科②（一般／2/12・13から選択）",
      "昭和医科①（一般・Ⅰ期／2/13・14から選択）",
      "東京医科①（一般・共テ／大学指定）",
      "東京女子医科①（一般／2/13〜15の指定日）",
      "北里①（一般・共テ前期／2/13〜15から選択）",
      "聖マリアンナ医科①（一般・前期／2/13・14の希望日）",
      "東海①（一般・共テ／2/13・14から選択）",
      "久留米（一般・前期／共テA）",
    ],
  },
  {
  ...
  },
  {
    ...
    second: [
      "帝京（共テ・前期）",
      "金沢医科①（一般・前期／2/17・18から選択）",
      "兵庫医科①（一般A／2/17・18から選択）",
    ],
  },
  {
    date: "2/18",
  ...
  },
  {
    ...
    first: [],
    second: [
      "東北医科薬科①（一般／2/20・21の指定日）",
      "獨協医科②（一般・前期／2/19・20から選択）",
      "国際医療福祉②（共テ／面接）",
      "杏林（共テ／個別テスト）",
      "東京慈恵会医科①（一般／2/20〜22の指定日）",
      "愛知医科②（一般・共テ／2/18〜20の希望日）",
      "関西医科①（一般・前期／2/20・21の希望をもとに指定）",
    ],
  },
  {
    date: "2/21",
