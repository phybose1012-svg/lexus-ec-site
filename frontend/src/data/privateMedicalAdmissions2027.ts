  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        procedure: "2/22 12:00まで（分納第2段階は3/3 12:00まで）",
        sourceUrl: "https://adm.showa-u.ac.jp/albums/abm.php?d=2405&f=abm00072376.pdf",
      }),
      officialRoute({
        name: "一般選抜 Ⅱ期",
        category: "general",
  ...
  },
  {
    ...
    routes: [
      officialRoute({
        ...
        application: "2026/12/14〜2027/1/20（書類1/21必着）",
        firstExam: "2/4",
        secondExam: "2/13・14の希望日（希望に沿えない場合あり）",
        result: "一次 2/10・最終 2/18",
        procedure: "2/25まで",
