...
export const examCalendar2027 = [
  ...
  { date: "1/26", weekday: "火", type: "general", label: "一般1次（面接）", schools: "自治医科" },
...
export const applicationDeadlineClusters2027 = [
  ...
  { date: "1/15", schools: "杏林・関西医科・順天堂・金沢医科・東北医科薬科（一般）・埼玉医科／愛知医科／大阪医科薬科（共テ）など" },
  ...
  { date: "1/22", schools: "藤田医科・愛知医科（一般）・東北医科薬科（共テ）・日本（N方式第1期）" },
  ...
  { date: "2/26", schools: "大阪医科薬科（後期）・愛知医科（共テ地域枠B）" },
