  ...
  university({
    ...
    routes: [
      route({
        ...
        publicationStatus: "outline",
        currentStudentEligible: true,
        eligibility: "2027年3月卒業見込みまたは2026年3月卒業で、将来、産業医学の道へ進む強い意志と使命感を持ち、指定する共通テスト科目を受験し、合格時に入学を確約できる者",
        exclusive: "専願",
        principalRecommendation: "不要",
        gradeRequirement: "評定の数値基準なし",
        restrictions: [
          "指定科目は数学2科目・理科2科目・英語（リーディング・リスニング）で、600点中480点以上",
          "志願者が募集人員の4倍を超えた場合は、提出書類による第1段階選抜を行うことがある",
          "2028年度入試から廃止予定（2027年度は実施）",
        ],
        events: [
          event("application-start", "2026-10-01", "出願開始"),
          ...
          event("procedure-deadline", "2027-02-26", "入学手続期間最終日"),
        ],
        sourceUrls: [
          "https://www.uoeh-u.ac.jp/library/nyusi/R9_jissiyoko.pdf",
          "https://www.uoeh-u.ac.jp/Exam/med03.html",
          "https://www.uoeh-u.ac.jp/Exam/_8042.html",
        ],
        note: "提出書類とプレゼンテーション試験（資料作成90分、発表10分、質疑応答約20分）で上位10名以内を選び、その合格者を指定する大学入学共通テスト3教科の得点で最終判定する独立した総合型選抜です。入学手続期間は2027年2月25日・26日です。",
      }),
      route({
        id: "school-recommendation",
        officialName: "学校推薦型選抜",
        ...
        publicationStatus: "outline",
        currentStudentEligible: true,
        eligibility: "2027年3月卒業見込みまたは2026年3月卒業で、学校長から責任をもって専願推薦を受け、合格時に入学を確約できる者",
        exclusive: "専願",
        principalRecommendation: "必要",
        gradeRequirement: "全体・国数理社英5教科平均・数理英3教科平均のいずれか4.3以上。2026年3月卒業者は、卒業前に受験した指定共通テスト科目900点中720点以上でも可",
        restrictions: [
          "高校所在地による全国3ブロック制（募集人員は全体で25名以内）",
          "数学Ⅰ・Ⅱ・Ⅲ・A・B（数列）・C（ベクトル、平面上の曲線と複素数平面）を履修または履修見込み",
          "物理・化学・生物のうち2科目以上と、英語コミュニケーションⅠ～Ⅲ・論理表現Ⅰ・Ⅱを履修または履修見込み",
          "1校あたりの推薦人数に制限なし",
          "選抜試験では大学入学共通テストを免除",
        ],
        events: [
          ...
          event("procedure-deadline", "2026-12-17", "入学手続期間最終日"),
        ],
        sourceUrls: [
          "https://www.uoeh-u.ac.jp/library/nyusi/R9_jissiyoko.pdf",
          "https://www.uoeh-u.ac.jp/Exam/med02.html",
          "https://www.uoeh-u.ac.jp/Exam/_8042.html",
        ],
        note: "学校長の推薦書、調査書、志望理由書、特別活動記録、総合問題（120分）と面接（1人約20分）を総合評価します。入学手続期間は2026年12月16日・17日です。",
      }),
    ],
    excludedRoutes: ["一般選抜A方式・B方式・C方式は対象外"],
  }),
  university({
    id: "fukuoka",
    name: "福岡大学",
    ...
    scopeStatus: "available",
    publicationStatus: "partial",
    statusNote: "2027年度入試ガイドでA方式推薦・地域枠推薦と、A方式定員に含まれる附属校推薦を確認。学部留学生選抜 後期日程は完成版要項を掲載しています。推薦の完成版要項は9月中旬公表予定です。",
    officialUrl: "https://www.fukuoka-u.ac.jp/pdf/entrance-examinations/guidebook-entrance-examinations2027.pdf",
    routes: [
      route({
        id: "recommendation-a",
        officialName: "学校推薦型選抜 A方式推薦",
        category: "recommendation",
        quota: "40名（地域枠10名・附属校推薦最大8名を内数に含む）",
        publicationStatus: "outline",
        currentStudentEligible: true,
        eligibility: "日本国内の高等学校または中等教育学校を2027年3月卒業見込み、または2026年3月卒業し、学校長から推薦された者",
        exclusive: "専願",
        principalRecommendation: "必要",
        gradeRequirement: "医学科は全体の学習成績の状況3.7以上",
        restrictions: ["日本国内所在校", "2026年3月卒業者まで（1浪可）"],
        events: [
          event("application-start", "2026-11-01", "インターネット出願開始"),
          event("application-deadline", "2026-11-10", "インターネット出願締切"),
          event("first-exam", "2026-11-29", "試験（英語・数学・面接）"),
        ...
        sourceUrls: [
          ...
          "https://nyushi.fukuoka-u.ac.jp/nyushi/type-4/",
          "https://nyushi.fukuoka-u.ac.jp/webapp/11suisen/",
        ],
        note: "英語・数学（2科目60分、各50点）と面接（20点）で総合選考します。調査書等は面接評価に活用し、大学入学共通テストは使用しません。面接は前年度参考として受験生4～6名・面接者3名のグループ面接（約40分）です。",
      }),
      route({
        id: "recommendation-regional",
        officialName: "学校推薦型選抜 地域枠推薦",
        category: "regional",
        quota: "10名（A方式推薦40名の内数）",
        publicationStatus: "outline",
        currentStudentEligible: true,
        eligibility: "日本国内の高等学校または中等教育学校を2027年3月卒業見込み、または2026年3月卒業し、学校長から推薦され、地域・地域医療・研修参加の全条件を満たす者",
        exclusive: "専願",
        principalRecommendation: "必要",
        gradeRequirement: "医学科は全体の学習成績の状況3.7以上",
        restrictions: [
          "九州（沖縄を含む）・山口県内の高校等出身、または出願時に本人・保護者が同地域に居住",
          "九州（沖縄を含む）・山口県内の離島・僻地・地域医療に貢献する強い意思",
          "在学中の実習・研修と福岡大学の卒後臨床研修プログラム（初期2年・後期3年）への参加を確約",
        ],
        events: [
          event("application-start", "2026-11-01", "インターネット出願開始"),
          event("application-deadline", "2026-11-10", "インターネット出願締切"),
      ...
      route({
        id: "recommendation-affiliated",
        officialName: "学校推薦型選抜 附属校推薦",
        category: "designated",
        quota: "最大8名（A方式推薦40名の内数）",
        publicationStatus: "outline",
        currentStudentEligible: "unconfirmed",
        eligibility: "A方式推薦40名の内数として最大8名を募集。出願資格の詳細は対象校へ通知",
        exclusive: "未公表",
        principalRecommendation: "未公表",
        gradeRequirement: "対象校へ通知（数値基準は未公表）",
        restrictions: ["附属校を対象とする推薦。詳細は対象校へ通知"],
        events: [],
        sourceUrls: [
          "https://www.fukuoka-u.ac.jp/pdf/entrance-examinations/guidebook-entrance-examinations2027.pdf",
          "https://nyushi.fukuoka-u.ac.jp/nyushi/type-4/",
        ...
        note: "2027年度入試ガイドで募集人員の内数のみ公表されています。完成版要項の公表前のため、出願資格・推薦条件・日程は断定していません。",
      }),
      route({
        ...
        publicationStatus: "complete",
        currentStudentEligible: "conditional",
        eligibility: "外国籍（日本国籍との重国籍者を除く）で、外国の12年課程・同等資格・国際資格・日本国内高校等のいずれかを2027年3月31日までに修了・卒業見込みを含み、日本の小中高校等での在学が通算3年以内で、2026年度日本留学試験の指定科目を日本語で受験した者",
        exclusive: "併願可",
        principalRecommendation: "不要",
        gradeRequirement: "評定の数値基準なし。日本語能力B2以上が必要で、EJUの出願基準点は設定しない",
        restrictions: [
          "日本国籍との重国籍者を除く外国籍",
          "日本の小学校・中学校・高校等での在学期間は通算3年以内",
          "2026年度EJUを日本語で受験（日本語、数学コース2、理科2科目）",
          "授業を受けられる日本語能力（B2以上）",
        ],
        events: [
          event("application-start", "2026-11-30", "出願受付・検定料支払期間開始"),
          event("application-deadline", "2026-12-04", "出願書類・検定料支払締切", { deadlineRule: "必着" }),
          event("first-exam", "2027-02-08", "本学試験（英語・小論文・面接）", { time: "9:30集合、10:00～（面接13:30～）" }),
          event("final-result", "2027-02-23", "合格発表", { time: "10:00" }),
          event("procedure-deadline", "2027-03-01", "入学申込金納入締切"),
          event("procedure-deadline", "2027-03-08", "第一期分学費等納入・入学手続書類締切", { deadlineRule: "必着" }),
        ],
        sourceUrls: [
        ...
        note: "2026年度EJUの日本語・数学コース2・理科2科目、本学の英語・小論文・個人面接、書類審査で総合選考します。2027年度からEJUの出願基準点はなく、大学入学共通テストは使用しません。前期日程との併願も可能です。",
      }),
    ],
    excludedRoutes: [
      "総合型選抜・帰国生徒選抜・社会人選抜・編転学士選抜・アスリート特別選抜は医学科を対象としないため除外",
      "一般選抜（系統別日程・前期日程・後期日程・共通テスト併用型）と共通テスト利用型は対象外",
    ],
  }),
];
