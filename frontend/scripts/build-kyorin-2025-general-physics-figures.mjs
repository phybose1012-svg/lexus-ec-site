...
export function choiceValue(choice,u){switch(choice){case 1:return .65;case 2:return .65*Math.abs(Math.cos(u));case 3:return .25+.65*Math.abs(1-2*((u/Math.PI)%1));case 4:return .65+.3*Math.sin(u);case 5:return .65-.25*Math.cos(u);case 6:return .35*(1+Math.cos(u));default:throw Error('Unknown choice');}}
