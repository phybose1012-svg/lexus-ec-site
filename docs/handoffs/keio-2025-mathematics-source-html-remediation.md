...
> 2026-09-10更新：この文書は修復前の依頼記録です。ユーザー提示の修復レポートを受けてライブラリへ反映しました。現状・参照ハッシュ・再生成・検証範囲は `keio-2025-mathematics-remediation-applied.md` を参照してください。人間の承認・権利確認は未完了です。
